...
2021-10-15 に、厚生科学審議会 (予防接種・ワクチン分科会 副反応検討部会)  が開催されました。  
しかしこの会議では、私がこれまで以下で csv 化してきた pdf 資料が示されませんでした。  
  
その代わり、心筋炎に関する資料が示されています。  
これが今後も継続する方針なのか、今回のことだけなのかは、不明です。  
（この「今回だけなのか」についての分かりやすい説明がないのは、不満です。）  
この事情ですので、2021-10-15 についての対応する csv データは、今のところありません。  
もしかすると、上に書いた心筋炎のデータのうち、処理できそうなものを csv 化するかも知れませんが、、、。  
