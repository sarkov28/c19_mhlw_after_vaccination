...
- 資料が公開されましたので、csv 化し、ここに置きました。2021-08-25/ 以下です。
...
3.8M ほどのファイルになりますが、  
2021-08-25/2021-08-25_PfMo_t2.csv  
...
（全体で 20000 件ほどあるデータの中の、4 件の事例ではあります。）
...
### 別の会議間での資料の関係について
2 つの会議における、モデルナの pdf ファイルの url は以下になっています。  
- 2021-08-04 モデルナ (以下 (04Mo) と書きます)  
  https://www.mhlw.go.jp/content/10601000/000816272.pdf
- 2021-08-25 モデルナ (以下 (25Mo) と書きます)  
