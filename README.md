...
の会議の pdf の資料の一部（「予防接種法に基づく医療機関からの副反応疑い報告状況について」）を
...
2021-10-15 の第70回会議では、該当するの資料 pdf が公開されませんでしたので、csv 化したデータはありません。この会議では、心筋炎に関する資料が示されました。    
...
- 2021-10-22 の第71回会議  
  https://www.mhlw.go.jp/stf/shingi2/0000208910_00033.html  
  の資料が公開されたので、csv 化し、2021-10-22/ 以下に置きました。
...
5M ほどのファイルになりますが、  
2021-10-22/2021-10-22_PfMoAz_t2.csv  
https://github.com/sarkov28/c19_mhlw_after_vaccination/raw/master/2021-10-22/2021-10-22_PfMoAz_t2.csv  
...
- 製造会社は、現在のところ、以下です。
  ...
  - Mo: モデルナのデータ
  - Az: アストラゼネカのデータ
  - PfMo: ファイザー、モデルナを1つに統合したデータ  
  - PfMoAz: ファイザー、モデルナ、アストラゼネカを1つに統合したデータ  
    統合方法については、[「製造会社毎のデータの統合方法」](#製造会社毎のデータの統合方法) の項を参照してください。
- データフォーマットは、[「データフォーマット」](#データフォーマット) の項を参照して下さい。

最初から1つに統合していないのは、厚生労働省のデータが製造会社毎に分かれているからです。
...
- 2021-10-22 の資料に関して  
  [2021-10-22/2021-10-22.md の「例外データについて」](2021-10-22/2021-10-22.md#例外データについて)を参照してください。
